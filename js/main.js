...
for (let i = 0; i < 2; i++) {
	...
	$('<img>', { class: 'card-img-top', src: 'http://pluspng.com/img-png/notebook-hd-png-for-work-use-it-as-a-normal-laptop-for-games-turn-it-into-a-tablet-with-a-full-hd-screen-or-for-watching-movies-or-presentations-just-flip-it-to-any-657.png'}).appendTo(nelem);
